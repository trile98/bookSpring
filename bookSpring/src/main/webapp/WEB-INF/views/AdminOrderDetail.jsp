            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a  href="/admin/order"> "Order" Table</a>
                        </li>
                        <li class="active"><a  href="/admin/order-detail"> "Order Detail" Table</a>
                        </li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2>Order Detail</h2>
                            <a href="/admin/order-detail/addNew" class="btn btn-success notika-btn-success waves-effect" >Add New</a>
                        </div>
	...
	<div class="modal animated rubberBand" id="EditOrderModal" role="dialog">
           <div class="modal-dialog modals-default">
               <div class="modal-content">
                   <form:form id="EditOrderForm" action="/admin/order-detail/edit/" method="POST">
	...
	<div class="modal animated rubberBand" id="OrderDeleteModal" role="dialog">
           <div class="modal-dialog modals-default">
               <div class="modal-content">
	                   ...
	                   <div class="modal-footer">
		                   <form:form id="OrderDeleteForm" action="/admin/order-detail/delete/" method="POST">
