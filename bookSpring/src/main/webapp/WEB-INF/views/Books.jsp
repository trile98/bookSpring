    ...
    <div id="templatemo_content_left">
        ...
        <div id="templatemo_content_right">
        	<div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[0].getTitle()}</h5>
                ...
                <div class="product_info">
					...
					<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[0].getPrice()}"/>₫ </h3>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[1].getTitle()}</h5>
                ...
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[1].getAuthor()}</i>
                  	<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[1].getPrice()}"/>₫</h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[2].getTitle()}</h5>
                ...
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[2].getAuthor()}</i>
      				<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[2].getPrice()}"/>₫</h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[3].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[3].getPrice()}"/>₫</h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[4].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[4].getPrice()}"/>₫</h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[5].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[5].getPrice()}"/>₫</h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[6].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[6].getPrice()}"/>₫ </h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[7].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[7].getPrice()}"/>₫ </h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[8].getTitle()}</h5>
                ...
                <div class="product_info">
        			...
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[8].getPrice()}"/>₫ </h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5 style="background: #543715">${listProduct[9].getTitle()}</h5>
