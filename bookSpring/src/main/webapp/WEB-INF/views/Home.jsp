  	...
  	<div class="row" style="padding:10px 0px;">
  		...
  		<div class="col-sm-4 col-md-4">
  				<div id="card-right">
					...
					<c:forEach items="${listProduct}" var="letter" begin="0" end ="9" step="2">
					    <div class="card-deck" style="width: 320px;">
  	...
  	<div class="col-sm-8 ">
  		...
  		<c:forEach var="i" begin="1" end="${page}">
  			<c:choose>
		         ...
		         <c:when test = "${i==1}">
		            <li class="paging-item page-item active p-2 my-flex-item"><a class="page-link mr-3" href="#">${i}</a></li>
		         </c:when>
		     	<c:when test = "${i<9}">
		            <li class="paging-item page-item paging-item p-2 my-flex-item"><a class="page-link mr-3 bg-info text-white" href="#">${i}</a></li>
		         </c:when>
		         <c:otherwise>
		            <li class="paging-item page-item  p-2 my-flex-item"><a class="page-link mr-2 bg-info text-white" href="#">${i}</a></li>
		         </c:otherwise>
		      </c:choose>
