...
<head>
	...
	<link href="<c:url value="resourcesHome/css/seach.css"/>" rel="stylesheet" type="text/css">
...
function MM_swapImage() { //v3.0
  var i,j=0,x,a=MM_swapImage.arguments; document.MM_sr=new Array; for(i=0;i<(a.length-2);i+=3)
   ...
   <link href="<c:url value="resourcesHome/styles.css"/>" rel="stylesheet" type="text/css">
    ...
    <div id="templatemo_content_left">
        ...
        <div id="templatemo_content_right">
        	<div class="templatemo_product_box">
            	<h5>${listProduct[0].getTitle()}</h5>
   	      		<img src="${listProduct[0].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
					author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[0].getAuthor()}</i>
					<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[0].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
	        		<div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
				</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[1].getTitle()}</h5>
       	    	<img src="${listProduct[1].getImageLink()}" alt="image" width="130" height="179" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[1].getAuthor()}</i>
                  	<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[1].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[2].getTitle()}</h5>
   	      		<img src="${listProduct[2].getImageLink()}" alt="image" width="132" height="194" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[2].getAuthor()}</i>
      				<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[2].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[3].getTitle()}</h5>
            	<img src="${listProduct[3].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[3].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[3].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5>${listProduct[4].getTitle()}</h5>
            	<img src="${listProduct[4].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[4].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[4].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[5].getTitle()}</h5>
            	<img src="${listProduct[5].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
        			author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[5].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[5].getPrice()}"/>₫ <br> <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5>${listProduct[6].getTitle()}</h5>
            	<img src="${listProduct[6].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[6].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[6].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[7].getTitle()}</h5>
            	<img src="${listProduct[7].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
        			author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[7].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[7].getPrice()}"/>₫ <br> <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
			...
			<div class="templatemo_product_box">
            	<h5>${listProduct[8].getTitle()}</h5>
            	<img src="${listProduct[8].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
                	author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[8].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[8].getPrice()}"/>₫ <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            ...
            <div class="templatemo_product_box">
            	<h5>${listProduct[9].getTitle()}</h5>
            	<img src="${listProduct[9].getImageLink()}" alt="image" width="129" height="178" />
                <div class="product_info">
        			author:<br><i style="font-family: Tahoma;color: olive;">${listProduct[9].getAuthor()}</i>
        			<h3><fmt:formatNumber type="number" maxFractionDigits="3" value="${listProduct[9].getPrice()}"/>₫ <br> <div style="font-size:12px"> (20% off)</div></h3>
                    <div class="buy_now_button" align="center"><a href="dathang.html">Đặt hàng</a></div>
                    <div class="detail_button" align="center"><a href=#>Chi tiết</a></div>
                </div>
                <div class="cleaner">&nbsp;</div>
            </div>
            <div style="clear: both;height: 40px;width: 100%">&nbsp;

            </div>
            <div class="cleaner_with_height">&nbsp;</div>
        <a href=#><img src="<c:url value="resourcesHome/images/sach1.jpg"/>" alt="ads" width="671" height="208" /></a>
        </div>
