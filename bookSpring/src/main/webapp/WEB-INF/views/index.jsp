...
<div class="container" style="background-color: #1C1C1B">
  	...
  	<div class="col-sm-8 ">
  		...
  		<c:forEach var="i" begin="1" end="${page}">
  			<c:choose>
		     	<c:when test = "${i<9}">
		            <li class=" page-item p-2 my-flex-item"><a class="paging-item page-link mr-3 bg-info text-white" href="Home/${i}">${i}</a></li>
		         </c:when>
		         <c:otherwise>
		            <li class="page-item  p-2 my-flex-item"><a class="paging-item page-link mr-2 bg-info text-white" href="Home/${i}">${i}</a></li>
		         </c:otherwise>
		      </c:choose>
