...
<link href="<c:url value="resourcesOrder/templatemo_style.css"/>" rel="stylesheet" type="text/css">
<!-- Font Awesome -->
...
<script type="text/javascript" src="<c:url value="resourcesOrder/js/custom.js"/>"></script>
 <style>
...
<div class="container" style="background-color: #1C1C1B">
    ...
    <div class="row" style="height: 240px">
      <div class="col-sm-12" style="padding: 0px 10px;height: 240px"><img alt="Logo" src="resourcesOrder/images/banner1.jpg"style="width:100%;height: 100%"></div>
   ...
   <div class="row">
		    ...
		    <li data-target="#myCarousel" data-slide-to="4"></li>
			   ...
			   <div class="carousel-inner">
			      <div class="carousel-item active" style="">
			         <a target="_blank" href="javascript:"><img src="<c:url value="resourcesOrder/images/nature/image1.jpg"/>" alt="hình 1" style="width: 100%" /> </a>
			      </div>
			      <div class="carousel-item">
			         <a target="_blank" href="javascript:"><img src="<c:url value="resourcesOrder/images/nature/image2.jpg"/>" alt="hình 2" style="width: 100%"/> </a>
			      </div>
			      <div class="carousel-item">
			         <a target="_blank" href="javascript:"><img src="<c:url value="resourcesOrder/images/nature/image3.jpg"/>" alt="hình 3" style="width: 100%"/> </a>
			      </div>
			      <div class="carousel-item">
			         <a target="_blank" href="javascript:"><img src="<c:url value="resourcesOrder/images/nature/image4.jpg"/>" alt="hình 4" style="width: 100%"/> </a>
			      </div>
			      <div class="carousel-item">
			         <a target="_blank" href="javascript:"><img src="<c:url value="resourcesOrder/images/nature/image5.jpg"/>" alt="hình 5" style="width: 100%"/> </a>
			      </div>
			   </div>
			   <!-- Controls -->
  	...
  	<div class="row" style="padding:10px 0px;">
  		...
  		<div class="col-sm-4 col-md-4">
  				<c:forEach items="${listProduct}" var="letter" begin="1" end ="9" step="2">
							  ...
							  <div class="card mb-3">
							    ...
							    <div class="card-body">
							      ...
							      <div class="form-row">
							      		...
							      		<form action="Order?id=${letter.getID()}" method="POST">
								      	 	<input type="hidden" id="hidden" name="ID" value="${letter.getID()}">
  	...
  	<div class="col-sm-8 ">
  		...
  		<c:forEach var="i" begin="1" end="${page}">
  			<c:choose>
		     	<c:when test = "${i<9}">
		            <li class=" page-item p-2 my-flex-item"><a class="paging-item page-link mr-3 bg-info text-white" onclick="myFunction()">${i}</a></li>
		         </c:when>
		         <c:otherwise>
		            <li class="page-item  p-2 my-flex-item"><a class="paging-item page-link mr-2 bg-info text-white" onclick="myFunction()">${i}</a></li>
		         </c:otherwise>
		      </c:choose>
	...
	<div class="row pb-3">
		<div class="col-sm-4 col-md-4" style="padding: 22% 0px 0px 10%">
			<img src="<c:url value="resourcesOrder/images/logo/nxbgd.jpg"/>" width="20%" height="width*20%">
	   		<img src="<c:url value="resourcesOrder/images/logo/nxbtre.jpg"/>" width="20%" height="width*20%">
	   		<img src="<c:url value="resourcesOrder/images/logo/nxbtt.jpg"/>" width="20%" height="width*20%">
		</div>
		<div class="col-sm-8 col-md-8 ads" >
			<a href=#><img src="<c:url value="resourcesOrder/images/sach1.jpg"/>" alt="ads"  /></a>
		</div>
	</div>
</div>
